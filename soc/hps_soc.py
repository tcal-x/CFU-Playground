...
class HpsSoC(LiteXSoC):
    ...
    def connect_cfu_to_lram(self):
        # create cfu <-> lram bus
        cfu_lram_bus_layout = [
           ("lram0", [("addr", 14), ("ren", 1), ("din", 32)]),
           ("lram1", [("addr", 14), ("ren", 1), ("din", 32)]),
           ("lram2", [("addr", 14), ("ren", 1), ("din", 32)]),
           ("lram3", [("addr", 14), ("ren", 1), ("din", 32)])]
...
def main():
    ...
    parser.add_argument("--cfu-backdoor", action="store_true", help="Create a direct connection between CFU and LRAM")
